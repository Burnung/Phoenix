...
void P3DGlslProgram::loadShader(const char *vetexName_ , const char *geometryName_ ,
...
void P3DGlslProgram::addShader(string sd,GLenum type){
...
void P3DGlslProgram::useShder(){
	//cout<<ShaderProgram<<endl;
	glUseProgram(ShaderProgram);
}

GLuint P3DGlslProgram::getUniform(const char *name){
	return glGetUniformLocation(ShaderProgram, name);
}
void P3DGlslProgram::DisUse(){
	glUseProgram(0);
}
